...
export default function ReportsView() {
  ...
  const getVerdictBadge = (v) => {
    ...
    if (text === 'INSUFFICIENT' || text === 'OUT_OF_SCOPE') {
    ...
    // Fallbacks
    if (text.includes('HIGH') || text.includes('H_SIF')) {
      return 'bg-red-700 text-white';
    }
    ...
    if (text.includes('LOW') || text.includes('L_SIF')) {
      return 'bg-rose-600 text-white';
    }
  ...
  // MAIN UI
  return (
    <div className="p-3 sm:p-4 lg:p-6 space-y-6 bg-[#f8fafc] min-h-screen text-slate-800 overflow-x-hidden">

      {/* 
          HEADER BANNER
       */}
      <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-[#012b28] via-[#013531] to-[#044e47] p-5 sm:p-6 text-white shadow-md">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-5">
          ...
          <div className="space-y-1 min-w-0">
            ...
            <p className="text-xs text-emerald-100/80 max-w-2xl leading-relaxed">
              Explore safety compliance summaries, SIF precursor metrics, and
              site risk logs.
            </p>
      ...
      {/* 
          MAIN REPORT AREA
          2XL BREAKPOINT PREVENTS CRAMPING ON LAPTOPS
       */}
      <div className="grid grid-cols-1 2xl:grid-cols-12 gap-6">
         ...
         */}
        <div className="2xl:col-span-7 bg-white rounded-xl border border-slate-200/80 shadow-xs flex flex-col h-[650px] lg:h-[800px] min-w-0">
          ...
          <div className="p-4 border-b border-slate-100 space-y-3">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 relative">
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-teal-700 bg-teal-50 border border-teal-200 hover:bg-teal-100 rounded-lg transition-colors shrink-0"
              >
                <FileText size={14} />
                Export CSV
              </button>
          ...
          <div className="flex-1 overflow-y-auto overflow-x-auto">
            ...
            {loadingList ? (
              ...
              <table className="w-full text-left text-xs whitespace-nowrap">
                ...
                <thead className="bg-slate-50 border-b border-slate-200 sticky top-0 text-slate-500 font-bold tracking-wider z-10">
                ...
                <tbody className="divide-y divide-slate-100">
                  ...
                  {filteredReports.map((report) => {
                    ...
                    if (text === 'NON_EVENT') {
                      rowBg =
                        'bg-[#10a37f]/10 hover:bg-[#10a37f]/20';
                    }
                    ...
                    return (
                      ...
                      <tr
                        ...
                        className={`
                          ...
                          ${
                            isSelected
                              ? 'border-l-4 border-l-teal-600 shadow-inner'
                      ...
                      >
                        ...
                        <td
                          className="p-3 font-mono font-semibold text-[10px] text-slate-600 truncate max-w-[100px]"
                        ...
                        <td
                          className="p-3 font-semibold text-slate-700 truncate max-w-[120px]"
                          title={report.lsr_primary}
                        >
                          {report.lsr_primary || 'No LSR'}
                        </td>
         ...
         */}
        <div className="2xl:col-span-5 bg-white rounded-xl border border-slate-200/80 shadow-xs h-auto 2xl:h-[800px] overflow-y-auto overflow-x-hidden p-4 sm:p-5 lg:p-6 min-w-0">

          {loadingDetail ? (

            <div className="flex flex-col items-center justify-center min-h-[500px] text-slate-500 space-y-3">
              <Loader2
                size={32}
            ...
            <div className="flex flex-col items-center justify-center min-h-[500px] text-red-500 space-y-3">
              <AlertCircle size={32} />
            ...
            <div className="flex flex-col items-center justify-center min-h-[500px] text-slate-400 space-y-3">
    ...
    <div className="space-y-6 min-w-0">
      ...
      >
        ...
        <div className="flex items-center gap-4 min-w-0">
          ...
          <div className="p-3 bg-white/20 backdrop-blur-sm rounded-full shrink-0">
            {verdictIcon}
          </div>
        ...
        {/* Confidence */}
        <div className="flex flex-col items-start md:items-center px-0 md:px-6 border-t md:border-t-0 md:border-l md:border-r border-white/20 py-3 md:py-0 w-full md:w-auto min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-1 text-[11px] font-semibold opacity-80">
        ...
        {/* Report ID */}
        <div className="flex flex-col gap-2 items-start md:items-end w-full md:w-auto min-w-0">

          <div className="text-left md:text-right mt-auto min-w-0">

            <p className="text-xs font-bold opacity-80 break-all">
              {report?.id ||
      ...
      {verdictDetail?.decision_path && (
        ...
        <div className="bg-slate-800 text-slate-200 rounded-lg p-3 font-mono text-[11px] sm:text-xs flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 overflow-hidden">
          ...
          <span className="text-slate-500 hidden sm:block shrink-0">
            |
          </span>

          <span className="break-words whitespace-normal leading-relaxed w-full min-w-0">
            {verdictDetail.decision_path.replace(
              /->/g,
              '→'
            )}
          </span>
      ...
      {/* 
          3. EVIDENCE + FOUR QUESTIONS
          
          IMPORTANT:
          - Normal/laptop screens: stacked
          - 1900px+: side-by-side
       */}

      <div className="grid grid-cols-1 gap-4 min-[1900px]:grid-cols-3 min-w-0">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 shadow-sm flex flex-col min-w-0 min-[1900px]:col-span-2">
          ...
          {/* Evidence Text */}
          <div className="flex-1 min-h-[220px] sm:min-h-[260px] bg-gray-50 rounded-lg p-4 border border-gray-100 text-sm md:text-base leading-relaxed text-gray-800 mb-4 whitespace-pre-wrap break-words overflow-hidden">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3 mb-2">
                    ...
                    <span className="text-xs font-bold text-gray-700 leading-tight flex-1 min-w-0">
                      {q.label}
                    </span>
                  ...
                  {fact.span && (
                    ...
                    <div className="text-[11px] text-gray-500 italic flex flex-col sm:flex-row sm:justify-between sm:items-end gap-2 mt-2 min-w-0">
                      ...
                      <span
                        className="text-[9px] uppercase bg-gray-200 px-1.5 py-0.5 rounded shrink-0 max-w-full truncate not-italic"
                        title={
                          fact.source ||
                          'ai'
                        }
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm min-w-0">
          ...
          <div className="space-y-3 text-xs">
            ...
            <div>
              ...
              <p className="font-bold text-gray-900 capitalize break-words">
                {(
                  safetyKnowledge?.hazard ||
                  'Unknown'
                ).replace(
                  /_/g,
                  ' '
            ...
            <div>
              ...
              <p className="font-bold text-gray-900 capitalize break-words">
                {(
                  safetyKnowledge?.potential_consequence ||
                  'Unknown'
                ).replace(
                  /_/g,
                  ' '
          ...
          <div className="space-y-3 text-xs">
            ...
            <div>
              ...
              <p className="font-bold text-gray-900 break-words">
                ...
                energy?.estimate_j !==
                  undefined
                  ? energy.estimate_j.toLocaleString()
                  : '—'}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="font-bold text-gray-900 break-words">
                ...
                energy?.threshold_j !==
                  undefined
                  ? energy.threshold_j.toLocaleString()
                  : '—'}
              </p>
            </div>
